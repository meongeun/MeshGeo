...
for i in nd[:32000]:
	...
	for u in range(0,500):
		...
		if fseries in line:
			...
			df.loc[i,'ABSTRACT'] = abstract.strip()
	...
	df.at[i,'GSM'] = samples
	df.at[i,'GSE_SUMMARY'] = summary.strip()
	df.loc[i,'SAMPLES_N'] = n
	print(i)	
	df.to_csv("/home/meongeun/meshGeo/geofinal/geo2mesh_3200_parse.tsv",sep="\t", index=False)
