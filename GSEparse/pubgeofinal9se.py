...
retmode = 'xml'
nd = pd.read_csv('/content/drive/My Drive/nd.tsv', sep='\t').values.tolist()
#content = f.read()
#print(ucon)
...
for i in nd[93349:]:
	n = 0
	f = gzip.open('/content/drive/My Drive/geoData2/'+str(i[0])+'_family.soft.gz','rt', encoding='utf-8', errors='ignore') 
	samples = ""
	summary = ""
	...
	print(i)	
	df.to_csv("/content/drive/My Drive/geo2mesh9/geo2mesh9_9.tsv",sep="\t", index=False)
