...
fabs = "abstract \""
fend = ".\","
df = pd.read_csv("./geofinal/final/geo2mesh9_fall5.tsv", sep='\t',header=0)
...
for i in range(0,20000):
	...
	if "error" in tabs:
		...
		continue
	print(i)
	df.loc[i,'ABSTRACT'] = iabs		
	df.to_csv("./geofinal/geo2mesh9fall5_errorchecked.tsv",sep="\t", index=False)
